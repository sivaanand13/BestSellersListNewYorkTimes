...
class BestSellerBooksRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        Log.v("B_TITLE", book.title.toString())
        Log.v("B_AUTHOR", book.author.toString())
        Log.v("B_RANK", book.rank.toString())
        Log.v("B_DESC", book.description.toString())
        Log.v("B_IMG", book.bookImageUrl.toString())
